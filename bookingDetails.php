            ...
            <div class="col-sm-10">
                <div class="card mt-4 mb-4 shadow-lg border-0">
                    <div class="card-body">
                        ...
                        $sql = "SELECT * FROM booking inner join user_tb on user_tb.userID = booking.userID where booking.bookingID='$booking_id' order by bookingID";
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            echo '<div class="row mt-3">';
                                ...
                                if($row['statusBook'] == 0){
                                    ...
                                    <div class="col-sm-3">
                                    <a href="dlslips.php?booking_id='.$row['bookingID'].'" class="btn btn-primary w-100">พิมพ์ตั๋ว</a>
                                    </div>';
                                }
                               echo '</div>';
                        }
